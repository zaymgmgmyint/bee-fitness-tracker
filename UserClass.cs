    ...
    internal class UserClass
    {
        ...
        public int CheckExisitingUser(string userName)
        {
            ...
            try
            {
                ...
                {
                    con.Open();              // Reopen connection if needed
                    cmd = new OleDbCommand(); // 🛠️ recreate cmd to prevent stale COM reference
                    cmd.Connection = con;
                }
                else
                {
                    cmd.Parameters.Clear();   // Clear old parameters when reusing
                }
